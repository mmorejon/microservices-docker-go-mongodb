...
```shell
timoni -n default apply website oci://<container-registry-url>
```
...
```shell
timoni -n default apply website oci://ghcr.io/<container-registry-url> \
...
```shell
timoni -n default delete website
```
