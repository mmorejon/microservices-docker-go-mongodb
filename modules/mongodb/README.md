...
```shell
timoni -n default apply mongodb oci://<container-registry-url>
```
...
```shell
timoni -n default apply mongodb oci://ghcr.io/<container-registry-url> \
...
```shell
timoni -n default delete mongodb
```
