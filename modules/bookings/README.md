...
```shell
timoni -n default apply bookings oci://<container-registry-url>
```
...
```shell
timoni -n default apply bookings oci://ghcr.io/<container-registry-url> \
...
```shell
timoni -n default delete bookings
```
