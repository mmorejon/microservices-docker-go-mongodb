...
```shell
timoni -n default apply movies oci://<container-registry-url>
```
...
```shell
timoni -n default apply movies oci://ghcr.io/<container-registry-url> \
...
```shell
timoni -n default delete movies
```
