...
```shell
timoni -n default apply showtimes oci://<container-registry-url>
```
...
```shell
timoni -n default apply showtimes oci://ghcr.io/<container-registry-url> \
...
```shell
timoni -n default delete showtimes
```
